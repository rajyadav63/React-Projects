    ...
    return (
        <div className='ml-[100px] flex justify-centre align-middle'>
            <div className='w-[45%] m-9'>
                ...
                <p className='w-[400px] mt-6 ml-10'>YOUR FEET DESERVE THE BEST AND WE’RE HERE TO HELP YOU WITH OUR SHOES.YOUR FEET DESERVE THE BEST AND WE'RE HERE TO HELP YOU WITH OUR SHOES.</p>
                ...
                <div className='mt-4 ml-9'>
                    <p className='text-1xl mb-2'>Also Availabe On</p>
